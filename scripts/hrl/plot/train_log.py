...
sys.path.append('./')
from utils.logfmt import load_hrl_train_log, read_hrl_train_args
...
def compare_parameters(filepath, savepath, n_tranche, figtype='eps'):
    ...
    for j, file in enumerate(files):
        ...
        ax[j,0].yaxis.set_major_locator(plt.MultipleLocator(2000))
        ax[j,0].yaxis.set_minor_locator(plt.MultipleLocator(200))
        ...
        ax[j,1].yaxis.set_major_locator(plt.MultipleLocator(10))
        ax[j,1].yaxis.set_minor_locator(plt.MultipleLocator(1))
        ...
        ax[j,2].yaxis.set_major_locator(plt.MultipleLocator(0.5))
        ax[j,2].yaxis.set_minor_locator(plt.MultipleLocator(0.05))
